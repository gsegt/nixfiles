...
1. Run `sed -i 's|./common/upgrade-diff.nix|# ./common/upgrade-diff.nix|g' /mnt/etc/nixos/system/common.nix /mnt/etc/nixos/home/common.nix` to avoid errors messages
